...
REM
REM Generated by Vivado on Sat Sep 27 19:06:29 +0530 2025
...
echo "xvlog --incr --relax -prj image_processor_vlog.prj"
call xvlog  --incr --relax -prj image_processor_vlog.prj -log xvlog.log
